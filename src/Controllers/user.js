...
const updateRoutine = async function (req, res) {
    try {
        ...
        let routines = await routineModel.findByIdAndUpdate({ _id: routineId }, { $set: { isCompleted: true } }, { new: true });
